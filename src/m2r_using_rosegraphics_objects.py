...
#            window = rg.SimpleWindow(width, 100)
#
...
#                detach_from, move_center_to, _get_coordinates_from_drawing
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                center, outline_color, outline_thickness
#
#     f. What does a RoseWindow RENDER method do?
#            draws the objects that are attached to the window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            the window will close instantly when the program is run if you do not call this method
#
